...
VALUES 
('peach candle', 'Santa', '9', TRUE),
('vanilla candle', 'Comet', '12', TRUE),
('lavender candle', 'Dasher', '17', FALSE),
('apple candle', 'Blitzen', '6', TRUE),
('peppermint soap', 'Cupid', '15', FALSE),
('rose candle', 'Vixen', '8', TRUE);
...
--
SELECT * FROM gifts LIMIT 3 OFFSET 2 ORDER BY value DESC;
--
-- finish
--
