...
CREATE TABLE gifts ( id SERIAL PRIMARY KEY, gift VARCHAR(100), giver VARCHAR(100), price INT, previously_regifted BOOLEAN );
...
INSERT INTO gifts (gift, giver, value, previously_regifted)
VALUES
('fruits candle', 'Me', '6', FALSE),
('dog', 'Adina', '19', TRUE),
('twister', 'Gary', '2', FALSE),
('plant', 'Gissette', '56', FALSE),
('wig', 'Weirdo', '1000', FALSE);
