...
CREATE TABLE 
 GIFTS 
 ( id SERIAL PRIMARY KEY, gift TEXT NOT NULL, giver TEXT, price INT, previously_regifted boolean DEFAULT false);
...
INSERT INTO gifts (gift, giver, value, previously_regifted)
VALUES
('bergamot soy candle', 'Markedia', '33', FALSE),
('luxury skincare collection', 'Michelle', '55', FALSE),
('frankincense & myrhh laundry detergent', 'God', '22', TRUE),
('handcrafted ceramic diffuser', 'Presence', '77', FALSE),
('vanilla & sandalwood potpourri', 'Aura', '11', TRUE);
...
--
SELECT gift FROM gifts ORDER BY value DESC LIMIT 3 OFFSET 2;
