...
CREATE TABLE gifts (id SERIAL PRIMARY KEY, gift TEXT, giver TEXT, price INT, previously_regifted BOOLEAN DEFAULT false);
...
--
INSERT INTO gifts (gift, giver, value, previously_regifted) VALUES ('peach candle', 'Santa', '9', TRUE),
('cadaverine candle', 'Sticky Nicky', '400', FALSE),
('red nose', 'Rudolf', '500', FALSE),
('Huion Insproy H950p', 'Panda Man', '50', TRUE),
('McDonalds Coupon', 'Creepy Clown', '5', FALSE)
;
...
--
SELECT * FROM gifts WHERE giver ILIKE 'santa' OR value > 30;

--
\echo Query for every gift whose giver is NOT Santa
--
SELECT * FROM gifts WHERE giver NOT ILIKE 'santa';
...
--
DELETE FROM gifts WHERE giver ILIKE 'santa' RETURNING value,gift;
