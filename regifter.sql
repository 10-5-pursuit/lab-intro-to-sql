...
VALUES
('cake', 'Justin', 10, TRUE),
('cream and cashmere candle', 'Goose Creek', 8, FALSE),
('Chew Omnibus', 'Myself', 100, FALSE),
('Money', 'Nicole', 20, FALSE),
('Socks', 'John Stamos', 13, TRUE);
...
--
DELETE FROM gifts WHERE giver ILIKE 'Santa' RETURNING price, gift;
