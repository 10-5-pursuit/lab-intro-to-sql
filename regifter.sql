...
INSERT INTO gifts (gift, giver, value, previously_regifted)
VALUES
('bluebrry bliss candle', 'Diamond', '19', FALSE),
('apple orchid', 'Delena', '38', FALSE),
('dove delight candle', 'Ronald', '17', TRUE),
('lavender', 'Santa', '52', FALSE),
('mousse', 'Santa', '25', TRUE),
('vanilla candle', 'Santa', '7', FALSE)
;
...
-- 
SELECT COUNT(value) FROM gifts WHERE gift ILIKE '%candle%';
