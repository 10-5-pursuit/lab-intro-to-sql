...
INSERT INTO gifts (gift, giver, value, previously_regifted)
VALUES
('red candle', 'mom', '5', TRUE),
('playstation', 'john', '400', TRUE),
('dr. squatch', 'zuckerberg', '30', FALSE),
('macbook', 'tim', '999', TRUE),
('iphone', 'craig', '899', FALSE)
;
...
-- 
SELECT SUM(value) FROM gifts WHERE gift ILIKE '%candle%';
